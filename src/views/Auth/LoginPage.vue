<template>
  ...
  >
    ...
    >
      ...
      <!-- Form Section -->
      <form @submit.prevent="login" class="flex flex-col gap-6 animate-fade-in">
        <div class="flex flex-col gap-2">
          <a-input
            label="اسم المستخدم او كود التسجيل"
            placeholder="اسم المستخدم او كود التسجيل"
...
// variables
const { login, uiFlags } = useAuthStore()
